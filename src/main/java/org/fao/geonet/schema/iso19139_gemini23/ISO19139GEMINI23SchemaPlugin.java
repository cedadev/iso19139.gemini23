...
package org.fao.geonet.schema.iso19139_gemini23;
...
import static org.fao.geonet.schema.iso19139_gemini23.ISO19139GEMINI23Namespaces.*;

/**
 * SchemaPlugin for iso19139.gemini23 metadata standard.
 *
 */
public class ISO19139GEMINI23SchemaPlugin
    ...
    ExportablePlugin,
    ISOPlugin {
    public static final String IDENTIFIER = "iso19139.gemini23";
    ...
    static {
        allNamespaces = ImmutableSet.<Namespace>builder()
            .add(ISO19139GEMINI23Namespaces.GCO)
            .add(ISO19139GEMINI23Namespaces.GMD)
            .add(SRV)
            .build();
    ...
    public ISO19139GEMINI23SchemaPlugin() {
